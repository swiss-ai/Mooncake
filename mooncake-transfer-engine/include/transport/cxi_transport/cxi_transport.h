...
class CxiTransport : public Transport {
   ...
   public:
    int onSetupCxiConnections(const HandShakeDesc &peer_desc,
   ...
   private:
    std::vector<std::shared_ptr<CxiContext>> context_list_;
