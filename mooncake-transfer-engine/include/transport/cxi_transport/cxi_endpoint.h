...
#ifndef CXI_ENDPOINT_H
#define CXI_ENDPOINT_H
...
// CxiEndpoint represents a libfabric endpoint for Cxi communication.
// Unlike RDMA QPs, Cxi uses RDM (Reliable Datagram) endpoints with
...
class CxiEndpoint {
   public:
    ...
    CxiEndpoint(CxiContext &context);
    ~CxiEndpoint();
